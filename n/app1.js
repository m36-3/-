...
const TOOLS_DB = [
  ...
  },
  {
    ...
    image: { alt: "Reinforced ETT", url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMMXb_Dzl3Sgk67nfiwUtA-SCNL6STLBXVzA&s" },
    supported_procedure_types: [
      "Head & Neck",
      "ENT / Airway surgery",
      "Neurosurgery"
  ...
  },
  {
    ...
    image: {
      ...
      url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZpSv15qL5hbV9ciAIo1CHOz0DABOOxiIoTA&s"
    },
    supported_procedure_types: [
      "ENT / Airway surgery",
      "Head & Neck",
  ...
  },
  {
    ...
    image: {
      ...
      url: "https://mainlinemedical.com/wp-content/uploads/2020/04/1-1117-35_Web.jpg"
    },
    supported_procedure_types: [
      "ENT / Airway surgery",
      "Head & Neck",
...
if (
  surgicalProcedures.includes(procedureType) &&
  tool.tool_category === "Endotracheal"
) {
  score += 4;
  reasons.push("definitive airway required for surgery");
}
if (
  tool.consciousness_levels &&
  !tool.consciousness_levels.includes(consciousness)
) {
  return null;
}
...
if (
  tool.urgency_levels &&
  !tool.urgency_levels.includes(urgency)
) {
  return null;
}
...
function buildCardHTML(entry, label) {
  ...
  const mainWarning =
    tool.warnings && tool.warnings.length
      ? tool.warnings[0]
  ...
  return (
    ...
    '">' +
      ...
      '<div class="card-image">' +
        '<img src="' + tool.image.url + '" alt="' + tool.image.alt + '">' +
      '</div>' +

      '<div class="card-body-simple">' +
        '<p><strong>Insertion:</strong> ' + tool.insertion_method + '</p>' +
        '<p class="warning"><strong>Important:</strong> ' + mainWarning + '</p>' +
      '</div>' +
...
function handleCalculateClick() {
  ...
  const consciousness = document.getElementById("consciousnessSelect").value;
